...
/* -------------------------------
          EXERCICE 
Créer une fonction(1) permettant de vérifier(2) l'age d'un visiteur(3) (prompt).
S'il a la majorité légale[if[, alors je lui souhaite la bienvenue(4, 
sinon[else], je fait une redirection sur Google(5) après lui avoir signalé le soucis(6(.
-------------------------------- */
/*1*/
fonction
...
/*---------------------------
LesOperateurs de comparaison
l'Opérateur de comparaison" == " signifie :Egal à il permet que 2 variables sont identiques.

l'Opérateur de comparaison" === " signifie : Stristement Egal à.Il va comparer la valeur,mais aussi le type!
...
/* -------------------------------
            EXERCICE :
J'arrive sur un Espace Sécurisé(1) au moyen 
d'un email(2) et d'un mot de passe(3).*/

let email = prompt("Hello ! What is your email ?", "<Saisir votre email>");
 console.log(email);
 console.log(typeof email);
 
 // -- 2b. Je lui demande son mdp --*/
 let mdp = parseInt(prompt("Hello " + email + " ! what is ur mdp ?", "<Saisir votre mdp>"));
 console.log(mdp);
 console.log(typeof mdp);
//Je dois saisir mon email et mon mot de passe afin d'être authentifié sur le site.(4)*/


 document.location.href = "http://fr.lmgtfy.com/?q=Majorit%C3%A9+L%C3%A9gale+en+France";

//En cas d'échec une alert m'informe du problème.(5)

//Si tous se passe bien, un message de bienvenue m'accueille(6)
